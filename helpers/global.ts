...
export const numDesigns = 120;

// prettier-ignore
export const filters = {
  celebration: [4,5,17,19,20,21,68,69,74,75,76,77,83,84,85,86,87,88,89,90,91,92,93,94,95,96,120,115],
  abstract: [3,7,8,13,14,15,16,44,45,63,64,65,66,67,70,71,72,78,79,81,116,117,118,119],
